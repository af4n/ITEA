...
const course = {"date":"01.12.2014","bank":"PB","baseCurrency":980,"baseCurrencyLit":"UAH",
"exchangeRate":[
        ...
        {"baseCurrency":"UAH","currency":"DKK","saleRateNB":2.5258930,"purchaseRateNB":2.5258930},
        ...
        {"baseCurrency":"UAH","currency":"LTL","saleRateNB":5.4433850,"purchaseRateNB":5.4433850},
        {"baseCurrency":"UAH","currency":"NOK","saleRateNB":2.1609570,"purchaseRateNB":2.1609570,"saleRate":2.6000000,"purchaseRate":2.1000000},
        {"baseCurrency":"UAH","currency":"SKK","saleRateNB":2.1609570,"purchaseRateNB":2.1609570},
        ...
        {"baseCurrency":"UAH","currency":"BYR","saleRateNB":0.0013900,"purchaseRateNB":0.0013900},
        ...
        {"baseCurrency":"UAH","currency":"GEL","saleRateNB":8.1500890,"purchaseRateNB":8.1500890},
        {"baseCurrency":"UAH","currency":"PLZ","saleRateNB":4.4922010,"purchaseRateNB":4.4922010,"saleRate":5.0000000,"purchaseRate":4.2000000}]}

window.onload = () => {
    const courseList = document.querySelector("#root");

    const greatCourse = (data) => {
    ...
    course.exchangeRate.forEach( function (value, index, array) {
        greatCourse(`Имя валюты ${value.currency} Продажа ${value.saleRateNB} Покупка ${value.purchaseRateNB}`)
    })
}